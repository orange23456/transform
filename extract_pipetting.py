...
src=Path(r'C:\Users\hz-user\Desktop\移液.docx')
out=root/'pipetting_source_images'
...
print('pipetting media',len(files),'paragraphs',len(txt),'tables',tables,'contact',out/'contact_sheet.jpg')
